...
class BuildMenu(Menu):
    def __init__(self, x, y):
        ...
        """
        #把三種塔分別設成按鈕，並存放至list讓之後可以讀取
        self._buttons = [Button(RAPID_TEST_BTN_IMAGE, "rapid test", self.rect.centerx, self.rect.centery + 75), Button(ALCOHOL_BTN_IMAGE, "alcohol", self.rect.centerx, self.rect.centery - 70), Button(PCR_BTN_IMAGE, "pcr", self.rect.centerx - 65, self.rect.centery + 10)]
